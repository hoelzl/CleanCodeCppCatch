...
{
    return shape.write_to_stream(s);
}
...
double Square::compute_area() const
{
    return side * side;
}
...
Point RawSquare::get_bottom_left_corner(const type& square)
{
    return square.point;
}
...
double RawSquare::get_side(const type& square)
{
    return square.data1;
}
...
double RawRectangle::get_width(const type& rectangle)
{
    return rectangle.data1;
}

double RawRectangle::get_height(const type& rectangle)
{
...
Point RawCircle::get_center(const type& circle)
{
    return circle.point;
}

void RawCircle::set_center(type& circle, Point point)
{
    circle.point = point;
}

double RawCircle::get_radius(const type& circle)
{
    return circle.data1;
}
