...
const std::string& Project::get_name() const { return name; }

double Project::get_assets() const { return assets; }

double Project::get_commissioned_pay() const { return commissioned_pay; }
